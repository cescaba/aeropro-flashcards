      ...
      <button type="button" class="vc-exam-reference-image reference_image" data-vc-exam-reference-image data-vc-exam-reference-image-fallback="<?php echo esc_url(VC_FLASHCARDS_URL . 'assets/icons/referencia.png'); ?>" hidden>
        <span class="vc-study-sessions-reference-image-control">
          ...
          <span class="vc-study-sessions-reference-image-copy">
            <span class="vc-study-sessions-reference-image-title"><?php esc_html_e('View reference image', 'vc-flashcards'); ?></span>
            <span class="vc-study-sessions-reference-image-subtitle"><?php esc_html_e('Click to expand', 'vc-flashcards'); ?></span>
          </span>
        </span>
